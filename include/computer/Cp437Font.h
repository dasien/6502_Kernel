// Cp437Font.h - GENERATED by vendor/cp437font/make_font.py; do not edit.
// IBM VGA 8x16 CP437 character ROM: 256 glyphs x 16 scanlines, one byte
// per scanline (bit 7 = leftmost pixel). Public-domain bitmap; see
// vendor/cp437font/README.md for provenance.
#ifndef CP437FONT_H
#define CP437FONT_H
...
namespace Computer
{
    // [glyph * 16 + scanline] -> 8 pixels. 256 glyphs.
    static const uint8_t kCp437Font[256 * 16] = {
