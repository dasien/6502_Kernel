...
# Add a task
.claude/queues/queue_manager.sh add "Task title" "agent-name" "priority" "Description"

# Start next task for an agent
.claude/queues/queue_manager.sh start agent-name
...
TASK_ID=$(./claude/queues/queue_manager.sh add "Analyze new monitor command" "requirements-analyst" "high" "Add D: command for hex/ASCII display")
