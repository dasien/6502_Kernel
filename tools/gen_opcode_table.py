...
def emit_md(table):
    ...
    lines.append("Auto-generated by `tools/gen_opcode_table.py` from "
                 "`src/computer/CPU6502.cpp`, which is the validated W65C02S "
                 "emulator. Do not edit this file by hand. It is the single source "
                 "of truth for the assembler and disassembler. Regenerate it after "
                 "changing any CPU opcode handler. The `opcode_table_current` test "
                 "fails if it is stale.")
    lines.append("")
    lines.append(f"{defined} of the 256 opcodes are defined. The other "
                 f"{256 - defined} are deterministic multi-byte NOPs and appear "
                 "here as `???`.")
    lines.append("")
