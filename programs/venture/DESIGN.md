...
**The one that comes into a room walks through the walls, at two thirds of Winky's
...
intruder steps on every tick *except* every Nth — `HALL_IN_SKIP`, where larger is
faster. Diagonal movement is what keeps it
