...
#include "../../../include/ui/DisplayWidget.h"
...
void DisplayWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->keyPressed((*reinterpret_cast< std::add_pointer_t<uint8_t>>(_a[1]))); break;
        case 1: _t->refreshDisplay(); break;
        case 2: _t->blinkCursor(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DisplayWidget::*)(uint8_t )>(_a, &DisplayWidget::keyPressed, 0))
            return;
    }
}
...
// SIGNAL 0
void DisplayWidget::keyPressed(uint8_t _t1)
{
